...
// HPGS::ConfigVar<std::set<LogDefine> >::ptr g_log_defines =
//     HPGS::Config::Lookup("logs", std::set<LogDefine>(), "logs config");

// struct LogIniter{
//     LogIniter(){
//         g_log_defines->addListner([](const std::set<LogDefine>& old_value,
//                         const std::set<LogDefine>& new_value){
//             HPGS_LOG_INFO(HPGS_LOG_ROOT()) << "on_log_conf_changed";
//             for(auto& i : new_value){
//                 auto it = old_value.find(i);
//                 HPGS::Logger::ptr logger;
//                 if(it == old_value.end()){
//                     logger = HPGS_LOG_NAME(i.name);
//                 }
//                 else{
//                     if(!(i == *it)){
//                         logger = HPGS_LOG_NAME(i.name);
...
//                 for(auto& a : i.appenders){
//                     HPGS::LogAppender::ptr ap;
//                     if(a.type == 1){
//                         ap.reset(new FileLogAppender(a.file));
//                     }
//                     else if(a.type == 2){
//                         if(!HPGS::EnvMgr::GetInstance()->has("d")){
...
//                 if(it == new_value.end()){
//                     auto logger = HPGS_LOG_NAME(i.name);
