#ifndef __HPGS_CONFIG_H__
#define __HPGS_CONFIG_H__
...
public:
    ...
    std::string toString() override {
        try{
            ...
            HPGS_LOG_ERROR(HPGS_LOG_ROOT()) << "ConfigVar::toString exception"
...
public:
    ...
    const T& default_value, const std::string& description = ""){
        ...
        if(name.find_first_not_of("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ._0123456789") != std::string::npos){
            HPGS_LOG_ERROR(HPGS_LOG_ROOT()) << "Lookup name invalid: " << name;
