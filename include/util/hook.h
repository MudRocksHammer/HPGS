#ifndef __HPGS_HOOK_H__
#define __HPGS_HOOK_H__
...
extern "C" {
    ...
    typedef ssize_t (*recvfrom_fun)(int cokfd, void* buf, size_t len, int flags, struct sockaddr* src_addr, socklen_t* addrlen);
