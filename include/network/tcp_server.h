#ifndef __HPGS_TCP_SERVER_H__
#define __HPGS_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(HPGS::IOManager* worker = HPGS::IOManager::GetThis()
              ,HPGS::IOManager* io_woker = HPGS::IOManager::GetThis()
              ,HPGS::IOManager* accept_worker = HPGS::IOManager::GetThis());
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(HPGS::Address::ptr addr, bool ssl = false);
