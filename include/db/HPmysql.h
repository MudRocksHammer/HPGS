...
public:
    ...
    int gerError() const { return m_errno; }
...
public:
    ...
    int getError() const { return m_errno; }
    const std::string& getErrStr() const { return m_errstr; }
...
public:
    ...
    HPGS::IStmt::ptr prepare(const std::string& sql) override;
...
typedef HPGS::Singleton<MySQLManager> MySQLMgr;
